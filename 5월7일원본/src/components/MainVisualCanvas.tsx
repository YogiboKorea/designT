      ...
      >
        ...
        {bgGraphicType === 'A' && (
          <svg width="100%" height="100%" style={{ position: 'absolute', inset: 0, zIndex: 0 }}>
            ...
            <circle cx="-100" cy="-50" r="500" fill="#ffffff" opacity="0.03" />
            <circle cx="1700" cy="200" r="300" fill="#ffffff" opacity="0.03" />
            <circle cx="1000" cy="800" r="350" fill="#ffffff" opacity="0.03" />

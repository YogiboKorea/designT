      ...
      if (type === 'Default') {
        ...
        nextWeb = {
          ...
          texts: [
            ...
            { id: t + 'webD2', text: '가장 편안한 빈백 소파.', position: { x: 150, y: 390 }, style: { color: '#FFFFFF', fontSize: 32, fontWeight: 500, textAlign: 'left', lineHeight: 1.1, letterSpacing: 0, fontFamily: "'Pretendard Variable', Pretendard, -apple-system, BlinkMacSystemFont, sans-serif" } },
            { id: t + 'webD3', text: '자세히 보기 >', position: { x: 150, y: 470 }, style: { color: '#FFFFFF', backgroundColor: '#62B5CC', fontSize: 20, fontWeight: 600, textAlign: 'center', lineHeight: 60, width: 220, isPill: true, fontFamily: "'Pretendard Variable', Pretendard, -apple-system, BlinkMacSystemFont, sans-serif" } }
          ]
        };
      } else if (type === 'E') {
        nextWeb = {
          ...
          texts: [
            ...
            { id: t + 'webE3', text: '가방과 스카프의\n2WAY 활용', position: { x: 180, y: 380 }, style: { color: '#FFFFFF', fontSize: 24, fontWeight: 400, textAlign: 'center', lineHeight: 1.3, letterSpacing: 0, fontFamily: "'Pretendard Variable', Pretendard, -apple-system, BlinkMacSystemFont, sans-serif", textShadow: '0 2px 5px rgba(0,0,0,0.3)' } },
            { id: t + 'webE4', text: '자세히 보기 >', position: { x: 500, y: 550 }, style: { color: '#FFFFFF', backgroundColor: 'rgba(98, 181, 204, 0.7)', fontSize: 18, fontWeight: 600, textAlign: 'center', lineHeight: 50, width: 200, isPill: true, fontFamily: "'Pretendard Variable', Pretendard, -apple-system, BlinkMacSystemFont, sans-serif" } }
          ]
        };
      }
